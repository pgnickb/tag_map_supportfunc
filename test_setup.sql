...
drop database if exists test_promscale_demo;
create database test_promscale_demo;

alter database test_promscale_demo
    set search_path = public, _ps_trace, ps_trace, pg_catalog;

\c test_promscale_demo
